...
#---------------------group by----------------------------------------------------
data_distance_high = data_distance[data_distance['Tier']=='High']
distance_gb = data_distance_high.groupby(['match','team','Win Lose','Tier'])
...
newdata_distance.to_csv('../../Data_Export/data_distance_high.csv', sep='\t')
