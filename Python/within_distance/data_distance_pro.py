...
#---------------------group by----------------------------------------------------
data_distance_pro = data_distance[data_distance['Tier']=='Pro']
distance_gb = data_distance_pro.groupby(['match','team','Win Lose','Tier'])
...
newdata_distance.to_csv('../../Data_Export/data_distance_pro.csv', sep='\t')
