...
#---------------------group by----------------------------------------------------
data_distance_normal = data_distance[data_distance['Tier']=='Normal']
distance_gb = data_distance_normal.groupby(['match','team','Win Lose','Tier'])
...
newdata_distance.to_csv('../../Data_Export/data_distance_normal.csv', sep='\t')
